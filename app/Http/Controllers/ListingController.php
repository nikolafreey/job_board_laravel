...
class ListingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //check if user is signed in and if not create one and autenticate him
        if (!$user) {
            $user = User::create([
                'name' => $request->name,
                'email' => $request->email,
            ...
            //create a user as stripe customer over Billable trait that we added earlier in User Model
